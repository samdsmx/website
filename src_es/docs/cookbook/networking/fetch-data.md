...
en nuestro fichero `pubspec.yaml`. Podemos [encontrar la última versión del paquete http en 
el sitio web de pub](https://pub.dartlang.org/packages/http#-installing-tab-).
...
artículo completo en [JSON y serialización](/docs/development/data-and-backend/json). 
...
Hurra! Ahora tenemos una función a la que podemos llamar para obtener un Post 
desde internet!
...
Aunque es conveniente, no se recomienda poner una llamada a una API en el 
método `build()`.
...
métodos 
[`initState`](https://docs.flutter.io/flutter/widgets/State/initState.html) o
...
[`State`](https://docs.flutter.io/flutter/widgets/State-class.html) para más
detalles.
...
Para más información sobre como probar esta funcionalidad, por favor vea la 
siguiente receta:

  * [Introducción a las pruebas unitarias](/docs/cookbook/testing/unit-test/)
