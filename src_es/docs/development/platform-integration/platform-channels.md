...
A continuación, añade el código actual Kotlin de Android que usa la API Android battery para 
...
Ahora deberiás poder ejecutar la app en iOS. Si estas usando el 
